...
public class CarrinhoController {
    ...
    public ResponseEntity<Object> adicionarProduto(@PathVariable int idProduto, @RequestParam int idUsuario, @RequestParam int quantidade) {
        return RequestResposta.retornar(carrinhoService.adicionarProduto(idProduto, idUsuario, quantidade));
    }
