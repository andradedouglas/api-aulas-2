...
public class ProdutoController {
    ...
    @PostMapping("/criar/{qtd}")
    public ResponseEntity<Object> criarProdutosEmLote(@PathVariable int qtd){
        return RequestResposta.retornar(produtoService.criarProdutosEmLote(qtd));
    }
