...
import com.unipe.api2.dto.Login;
...
public class UsuarioController {
    ...
    @GetMapping("/{id}/obter-endereco")
    public ResponseEntity<Object> obterEndereco(@PathVariable int id){
        return RequestResposta.retornar(usuarioService.obterEndereco(id));
    }
